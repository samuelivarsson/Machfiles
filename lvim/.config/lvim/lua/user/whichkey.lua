...
lvim.builtin.which_key.mappings["d"] = {
  ...
  L = { "<cmd>lua require'dap.ext.vscode'.load_launchjs()<cr>", "Load launch.json file" },
...
lvim.builtin.which_key.mappings["o"] = {
  ...
  i = { "<cmd>lua lvim.builtin.illuminate = false<cr>", "Illuminate off" },
  I = { "<cmd>lua lvim.builtin.illuminate = true<cr>", "Illuminate on" },
...
local m_mappings = {
  ...
  -- s = { "<cmd>lua require'telescope.builtin'.marks{}<cr>", "Show Bookmarks" },
  s = {
